...
const BrandText = () => {
    ...
    return (
        <div className={brand_font_part_inner}>
                ...
                <div className={font_part}>
                    ...
                    <div className={font}>
                        <div className={font_description}>
                            ...
                            <span
                                className={[brown_font1].join(" ")}>The quick brown fox jumps over the lazy dog.</span>
                            <span className={margin_adjust}>Proxima Nova - Regular</span>
                    ...
                    <div className={font}>
                        <div className={font_description}>
                            ...
                            <span
                                className={[brown_font2].join(" ")}>The quick brown fox jumps over the lazy dog.</span>
                            <span className={margin_adjust}>Proxima Nova - Regular</span>
