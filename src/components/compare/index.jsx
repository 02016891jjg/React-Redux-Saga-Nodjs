  ...
  render() {
    ...
    return lists ? (
      <div className="add_item_part animated fadeInRight">
              ...
              return (
                <li key={index}>
                  <div className="compare_titles">
                    ...
                    <button type="button" className="remove_item"><img src={BUTTON_REMOVE} /></button>
                  </div>
                </li>
              )
            })
        ...
        {
          count > 1 && (
            <button className="btn btn-primary add_button"><img src={VS_SOLID} /></button>
          )
        }
        {
          count == 1 && (
