...
import './styles.scss'
import { SUGGEST_IMG, SHARE_IMG, ICON_ARROW_UP, ICON_ARROW_DOWN } from 'common/images'
    ...
    <div className="iphn-hed">
      <div className="wrap_radio">
        ...
        <div className="sug_share">
          ...
          <div className="share_part" onClick={onShareClick}>
            <img src={SHARE_IMG} />
      ...
      <div className="click_drp" onClick={onArrowClick}>
        <span className="iphn-swt">
          <img
            src={isArrowClicked ? ICON_ARROW_UP : ICON_ARROW_DOWN}
          />
        </span>
      </div>
    </div>
