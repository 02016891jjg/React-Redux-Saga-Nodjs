...
import './styles.scss'
import { PHONE_IMG, BAGE_VERSUS_SMALL } from 'common/images'
...
class BannerProduction extends React.Component<Props, State> {
  ...
  render() {
    const { footerProducts, isBanner, versusFooterData } = this.props
    const bannerproducts = typeof footerProducts !== "undefined" ? footerProducts : versusFooterData
    console.log(bannerproducts)
    return (
      <div className={isBanner ? "banner_outer banner_diable" : "banner_outer"}>
                      ...
                      <div className="item_box">
                        <div className="banner_title">
                          ...
                          <div className="margin_description">
                            <p className="brand_title">{item[0].v_brand_name}</p>
                            <p className="device_name">{item[0].device_name}</p>
                          </div>
                        </div>
                      </div>
                      <div className="button_adjust">
                        {/* <button className="vs_button btn btn-primary" onClick={() => this.props.onVSButtonClick(item[0].device_id, item[1].device_id)}> <img src={VS_ICON} className="Vsicon" /></button> */}
                        <img src={BAGE_VERSUS_SMALL} />
                      </div>
                      <div className="item_box">
                        <div className="banner_title">
                          <div className="banner_image">
                          ...
                          <div className="margin_description">
                            <p className="brand_title">{item[1].v_brand_name}</p>
