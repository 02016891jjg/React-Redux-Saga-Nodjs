...
class StandardDetailPage extends React.Component<Props, State> {
  ...
  render() {
    ...
    const specfications = typeof smartPhoneDetails.smartPhoneDetails !=="undefined" && typeof smartPhoneDetails.smartPhoneDetails[0] !=="undefined"?smartPhoneDetails.smartPhoneDetails[0].result:{};
    ...
    return (
      <div className="standard_wrapper">
        <Header headerClass="assitant_header" />
