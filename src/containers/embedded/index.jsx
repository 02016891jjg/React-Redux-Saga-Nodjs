...
import './styles.scss'
import ProductDescriptionTable from 'components/productDescriptionTableforembed'
...
class Embedded extends Component<Props> {
  ...
  constructor(props: Props) {
    ...
    props.dispatch({
      ...
      payload: { url: GET_DETAIL_PRODUCTION, deviceID: deviceId, status: 1 }
    })
  }
  onhandleShow = (index) => {
    console.log(index);
    ...
    var header_offset = document.getElementById("main-header");
    console.log(object)
    // object.scrollIntoView({ block: 'end', behavior: 'smooth' });
    window.scrollTo({ top: object.offsetTop - header_offset.offsetHeight, behavior: 'smooth' });
  ...
  render() {
    ...
    return (
      <div className="App">
        <header className="main-header" id="main-header">
          <div className="header_part">
            <div className="view_part">
              <h3 className="device_title">{device_name}</h3>
        ...
        <a target="_blank" href="https://techspecs.io">
          <div className="modal_part">

            <h3 className="font_size">Powered by</h3>
